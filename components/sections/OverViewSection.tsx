            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    <div className="md:w-1/2 lg:w-2/4 ">
                        ...
                        >
                            Learn more about our technology <ArrowRight size={15} />
                        </Link>
                    </div>
                ...
                <div className="mt-10">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            "What if I doesn’t reach its goal?",
                        ].map((question, index) => (
                            <div
                                key={index}
                                ...
                                {openFAQ === index && (
                                    <div className="p-4 text-sm md:text-base text-gray-500">
                                        ...
                                        {index === 3 && (
                                            ...
                                            >
                                                Starting a project on Fortrez is simple. You can
                                        ...
                                        {index === 4 && (
                                            ...
                                            >
                                                If your campaign doesn&lsquo;t meet its funding target, all
